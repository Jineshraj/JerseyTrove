...
const Latest = () => {
  ...
  // Set default sort to newest (hidden from the dropdown UI)
  useEffect(() => {
    setSortBy("newest");
  }, [setSortBy]);
    ...
    <div className="bg-white">
      <div className="mx-auto max-w-[1400px] px-4 pb-16 pt-20 sm:px-5 sm:pb-24 lg:px-6">
        ...
        <div className="border-b border-gray-200 pb-8">
          <h1 className="text-5xl font-black text-gray-900">Latest Drops</h1>
          <p className="mt-3 text-base text-gray-500">
            Fresh drops, ready to wear. The newest kits first.
          </p>
        </div>
